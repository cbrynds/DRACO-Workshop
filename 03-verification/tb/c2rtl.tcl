...
set N 32
set SPEC_NAME "remove_lso"
set IMPL_NAME "remove_lso_bit_level"

proc compile_spec {} { 
    global SPEC_NAME
    create_design -name spec -top DPV_wrapper -cov 
    cppan -I. "../src/cpp/${SPEC_NAME}.cpp"
    compile_design spec  
}
...
proc compile_impl {} {
    ...
    vcs -sverilog -pvalue+N=${N} "../../02-design/src/rtl/${IMPL_NAME}.sv"
    compile_design impl
}
